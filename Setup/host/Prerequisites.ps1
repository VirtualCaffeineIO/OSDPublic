...
$ADKUri = 'https://go.microsoft.com/fwlink/?linkid=2243390'
Write-Host -ForegroundColor Green '[+] Downloading Windows ADK 10.1.25398.1 (Republished in January 2025) Setup from' $ADKUri
...
Write-Host -ForegroundColor Green '[+] Downloading and Installing Windows ADK 10.1.25398.1 (Republished in January 2025)'
...
$WinPEUri = 'https://go.microsoft.com/fwlink/?linkid=2243391'
Write-Host -ForegroundColor Green '[+] Downloading Windows PE add-on for the Windows ADK 10.1.25398.1 (Republished in January 2025) Setup from' $WinPEUri
...
Write-Host -ForegroundColor Green '[+] Downloading and Installing Windows PE add-on for the Windows ADK 10.1.25398.1 (Republished in January 2025)'
...
# Complete
Write-Host -ForegroundColor Green '[+] Windows ADK 10.1.25398.1 (Republished in January 2025) has been installed'
#endregion
